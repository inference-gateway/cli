...
import (
	...
	"github.com/inference-gateway/cli/internal/agent/application"
)
...
type FakeA2AAgentService struct {
	...
	getAgentCardsReturns struct {
		result1 []*application.CachedAgentCard
		result2 error
	}
...
var _ application.A2AAgentService = new(FakeA2AAgentService)
