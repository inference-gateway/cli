...
func (fake *FakeBackgroundTaskRegistry) GetPollingState(arg1 string) *agentdomain.TaskPollingState {
...
func (fake *FakeBackgroundTaskRegistry) GetPollingStateCalls(stub func(string) *agentdomain.TaskPollingState) {
	fake.getPollingStateMutex.Lock()
...
func (fake *FakeBackgroundTaskRegistry) GetPollingStateReturns(result1 *agentdomain.TaskPollingState) {
	fake.getPollingStateMutex.Lock()
	defer fake.getPollingStateMutex.Unlock()
...
func (fake *FakeBackgroundTaskRegistry) GetPollingStateReturnsOnCall(i int, result1 *agentdomain.TaskPollingState) {
	fake.getPollingStateMutex.Lock()
	defer fake.getPollingStateMutex.Unlock()
	fake.GetPollingStateStub = nil
...
func (fake *FakeBackgroundTaskRegistry) StartPolling(arg1 string, arg2 *agentdomain.TaskPollingState) {
...
func (fake *FakeBackgroundTaskRegistry) StartPollingCalls(stub func(string, *agentdomain.TaskPollingState)) {
	fake.startPollingMutex.Lock()
	defer fake.startPollingMutex.Unlock()
	fake.StartPollingStub = stub
}

func (fake *FakeBackgroundTaskRegistry) StartPollingArgsForCall(i int) (string, *agentdomain.TaskPollingState) {
	fake.startPollingMutex.RLock()
	defer fake.startPollingMutex.RUnlock()
