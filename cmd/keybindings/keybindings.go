	...
	command.AddCommand(
		&cobra.Command{
			...
			RunE: func(cmd *cobra.Command, args []string) error {
				return listKeybindings(state.Config(), cmd, args)
			},
		},
		&cobra.Command{
			Use:   "reset",
		...
		&cobra.Command{
			...
			RunE: func(cmd *cobra.Command, args []string) error {
				return validateKeybindings(state.Config(), cmd, args)
			},
		},
		&cobra.Command{
...
func listKeybindings(cfg *config.Config, cmd *cobra.Command, args []string) error {
...
func resetKeybindings(cmd *cobra.Command, args []string) error {
	path, err := runtime.KeybindingsConfigWritePath(runtime.ProjectFlag(cmd))
	if err != nil {
		return err
	}
...
func validateKeybindings(cfg *config.Config, cmd *cobra.Command, args []string) error {
