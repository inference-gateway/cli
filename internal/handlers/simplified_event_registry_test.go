...
func TestSimplifiedEventRegistry_AutoRegistration(t *testing.T) {
	tests := []struct {
		name          string
		handler       interface{}
		shouldPanic   bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			NewSimplifiedEventRegistry(tt.handler)
		})
	}
}

func TestSimplifiedEventRegistry_Handle(t *testing.T) {
	tests := []struct {
		name      string
		event     tea.Msg
		wantPanic bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			registry := NewSimplifiedEventRegistry(&MockHandler{})
