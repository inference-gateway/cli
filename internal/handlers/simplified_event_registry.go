...
type SimplifiedEventRegistry struct {
	handlers map[reflect.Type]reflect.Method
}

func NewSimplifiedEventRegistry(handler interface{}) *SimplifiedEventRegistry {
	registry := &SimplifiedEventRegistry{
...
func (r *SimplifiedEventRegistry) autoRegisterHandlers(handler interface{}) {
...
func (r *SimplifiedEventRegistry) Handle(handler interface{}, msg tea.Msg, stateManager *services.StateManager) (tea.Model, tea.Cmd) {
