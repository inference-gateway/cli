...
func TestGithubFetchTool_Definition(t *testing.T) {
	cfg := &config.Config{
	...
	tool := NewGithubFetchTool(cfg)
	def := tool.Definition()

	if def.Name != "GithubFetch" {
		t.Errorf("Expected tool name 'GithubFetch', got %s", def.Name)
	}
...
func TestGithubFetchTool_IsEnabled(t *testing.T) {
	tests := []struct {
		name          string
		toolsEnabled  bool
		githubEnabled bool
...
func TestGithubFetchTool_Validate_ValidCases(t *testing.T) {
	cfg := &config.Config{
		Tools: config.ToolsConfig{
			Enabled: true,
			GithubFetch: config.GithubFetchToolConfig{
...
func TestGithubFetchTool_Validate_InvalidCases(t *testing.T) {
	cfg := &config.Config{
		Tools: config.ToolsConfig{
			Enabled: true,
			GithubFetch: config.GithubFetchToolConfig{
...
func TestGithubFetchTool_Execute_Disabled(t *testing.T) {
	cfg := &config.Config{
		Tools: config.ToolsConfig{
			Enabled: false,
			GithubFetch: config.GithubFetchToolConfig{
...
func TestGithubFetchTool_Execute_GithubDisabled(t *testing.T) {
	cfg := &config.Config{
		Tools: config.ToolsConfig{
			Enabled: true,
			GithubFetch: config.GithubFetchToolConfig{
	...
	result, err := tool.Execute(ctx, args)
	if err == nil {
		t.Fatal("Expected error when GitHub fetch is disabled")
	}

	if result != nil {
		t.Error("Expected nil result when GitHub fetch is disabled")
	}
}

func TestGithubFetchTool_Execute_InvalidArgs(t *testing.T) {
	cfg := &config.Config{
		Tools: config.ToolsConfig{
			Enabled: true,
			GithubFetch: config.GithubFetchToolConfig{
...
func TestGithubFetchTool_Execute_Success(t *testing.T) {
...
func TestGithubFetchTool_Execute_APIError(t *testing.T) {
...
func TestGithubFetchTool_Execute_IssuesList(t *testing.T) {
