...
type StatusView struct {
	...
	debugInfo        string
	width            int
	statusType       tui.StatusType
	progress         *tui.StatusProgress
...
func (sv *StatusView) ShowStatus(message string) {
	...
	sv.isError = false
	sv.isSpinner = false
	sv.statusType = tui.StatusDefault
	sv.progress = nil
}
...
func (sv *StatusView) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tui.ClearErrorEvent:
		sv.ClearStatus()

	case tui.SaveStatusStateEvent:
		sv.SaveCurrentState()
