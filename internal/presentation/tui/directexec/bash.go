...
// auto-fix.
func (s *Service) HandleBashCommandCompleted(msg tui.BashCommandCompletedEvent) tea.Cmd {
	s.stateManager.EndToolExecution()

	cmds := []tea.Cmd{
		func() tea.Msg {
			return tui.UpdateHistoryEvent{History: msg.History}
		},
	}

	if msg.ErrorMessage != "" {
		cmds = append(cmds, func() tea.Msg {
			return tui.ShowErrorEvent{Error: msg.ErrorMessage, Sticky: false}
		})
	}
