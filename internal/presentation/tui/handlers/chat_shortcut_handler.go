...
func (s *ChatShortcutHandler) handleSwitchModelSideEffect() tea.Msg {
	_ = s.handler.stateManager.TransitionToView(tui.ViewStateModelSelection)
	return tui.SetStatusEvent{
...
func (s *ChatShortcutHandler) handleSwitchThemeSideEffect() tea.Msg {
	_ = s.handler.stateManager.TransitionToView(tui.ViewStateThemeSelection)
	return tui.SetStatusEvent{
		Message:    "",
		Spinner:    false,
		StatusType: tui.StatusDefault,
...
func (s *ChatShortcutHandler) handleShowHelpSideEffect() tea.Msg {
	return tui.TriggerHelpViewEvent{}
}
...
func (s *ChatShortcutHandler) handleShowConversationSelectionSideEffect() tea.Msg {
	if err := s.handler.stateManager.TransitionToView(tui.ViewStateConversationSelection); err != nil {
...
func (s *ChatShortcutHandler) handleShowA2ATaskManagementSideEffect() tea.Msg {
	if err := s.handler.stateManager.TransitionToView(tui.ViewStateA2ATaskManagement); err != nil {
...
func (s *ChatShortcutHandler) handleShowDiffViewerSideEffect() tea.Msg {
	...
	if err := s.handler.stateManager.TransitionToView(tui.ViewStateDiffViewer); err != nil {
...
func (s *ChatShortcutHandler) handleShowExplorerSideEffect() tea.Msg {
	if err := s.handler.stateManager.TransitionToView(tui.ViewStateExplorer); err != nil {
...
func (s *ChatShortcutHandler) handleSetInputSideEffect(data any) tea.Msg {
	...
	return tea.Batch(
		...
		func() tea.Msg {
			return tui.SetInputEvent{Text: text}
		},
	)()
}
