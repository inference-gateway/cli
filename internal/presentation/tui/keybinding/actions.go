...
func defaultActions() []*KeyAction {
	chatView := func(conds ...ContextCondition) KeyContext {
		return KeyContext{
			Views:      []tui.ViewState{tui.ViewStateChat},
			Conditions: conds,
		}
	}
	planApprovalView := KeyContext{Views: []tui.ViewState{tui.ViewStatePlanApproval}}
...
func handleCancel(app KeyHandlerContext, keyMsg tea.KeyPressMsg) tea.Cmd {
	...
	if autocomplete != nil && autocomplete.IsVisible() {
		return func() tea.Msg {
			return tui.AutocompleteHideEvent{}
		}
	}
	...
	if planApprovalState != nil {
		return func() tea.Msg {
			return tui.PlanApprovalResponseEvent{
...
func flashStatus(app KeyHandlerContext, message string) tea.Cmd {
	...
	if statusView != nil && statusView.IsShowingSpinner() {
		return tea.Batch(
			func() tea.Msg { return tui.SaveStatusStateEvent{} },
			func() tea.Msg { return tui.SetStatusEvent{Message: message, Spinner: false} },
			func() tea.Msg {
	...
	return tea.Batch(
		...
		func() tea.Msg {
			time.Sleep(clipboardFlashDuration)
			return tui.SetStatusEvent{Message: "", Spinner: false}
		},
	)
}
...
func handleCursorLeftOrPlanNav(app KeyHandlerContext, keyMsg tea.KeyPressMsg) tea.Cmd {
	...
	if planApprovalState != nil {
		...
		return func() tea.Msg {
			return tui.PlanApprovalSelectionChangedEvent{NewIndex: newIndex}
		}
	}
...
func handleHistoryDown(app KeyHandlerContext, keyMsg tea.KeyPressMsg) tea.Cmd {
	...
	if inputView != nil {
		...
		if !inputView.IsNavigatingHistory() {
			return func() tea.Msg { return tui.FocusStatusBarEvent{} }
		}
