...
func TestShouldRouteToUIComponents(t *testing.T) {
	tests := []struct {
		...
		{"ui update history", tui.UpdateHistoryEvent{}, true},
		{"ui streaming content", tui.StreamingContentEvent{}, true},
		{"ui set status", tui.SetStatusEvent{}, true},
		{"ui show error", tui.ShowErrorEvent{}, true},
		{"ui clear input", tui.ClearInputEvent{}, true},
		{"ui agent status update", tui.AgentStatusUpdateEvent{}, true},
		{"ui git pr resolved", tui.GitPRResolvedEvent{}, true},
