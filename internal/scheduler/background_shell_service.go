...
type BackgroundShellService struct {
	shellTracker scheddomain.ShellTracker
...
func (s *BackgroundShellService) CancelShell(shellID string) error {
	...
	return s.supervisor.Wind(shellID, scheddomain.WindStop)
}
...
func (s *BackgroundShellService) GetShell(shellID string) *scheddomain.BackgroundShell {
