...
func createTestRegistry() *Registry {
	...
	return NewRegistry(cfg, nil, nil, nil, nil, nil, nil, nil, nil)
}
...
func TestRegistry_ListAvailableTools(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			registry := NewRegistry(tt.config, nil, nil, nil, nil, nil, nil, nil, nil)
			tools := registry.ListAvailableTools()
...
func TestRegistry_NewRegistry_DoesNotBlockOnMCP(t *testing.T) {
	...
	go func() {
		done <- NewRegistry(cfg, nil, nil, nil, blocker, nil, nil, nil, nil)
	}()
...
func TestRegistry_ConcurrentMCPToolAccess(t *testing.T) {
	...
	registry := NewRegistry(cfg, nil, nil, nil, &stubMCPManager{client: &agentdomainmocks.FakeMCPClient{}}, nil, nil, nil, nil)
